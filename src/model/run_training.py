...
from src.features.build_features import build_feature_table, FEATURE_COLUMNS  # noqa: E402
...
def run(num_applicants: int = 250, model_out: Path | None = None) -> dict:
    ...
    print(f"      Feature table: {full_df.shape[0]} rows × {len(FEATURE_COLUMNS)} features")
    ...
    print(f"  TP/FP/TN/FN     : {report['tp']}/{report['fp']}/{report['tn']}/{report['fn']}")
